...
function createFakeMonetizationPlanData() {
  return {
    ...
    publicationSchedule: [
      ...
      { dayOfWeek: 'Quinta', content: 'Teaser 1', platform: 'YouTube Shorts' },
      { dayOfWeek: 'Sexta', content: 'Teaser 2', platform: 'YouTube Shorts' },
      { dayOfWeek: 'Domingo', content: 'Teaser 3', platform: 'YouTube Shorts' },
      { dayOfWeek: 'Segunda', content: 'Teaser 4', platform: 'YouTube Shorts' }
    ],
